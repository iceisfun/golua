// Package parser implements a recursive descent parser for Lua 5.5, producing
// an abstract syntax tree (AST) from source text.
//
// The parser uses the lexer to tokenize input and builds an AST following
// Lua 5.5's grammar with precedence-climbing for expressions. It supports
// all Lua 5.5 syntax including goto/labels, local attributes (<const>, <close>),
