-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: goto statements
...
-- [Test 1] [test-suite] goto: error messages
...
do
  ...
  -- goto to correct label when nested (renamed to avoid conflict with outer ::l3::)
  do goto l3b; ::l3b:: end   -- does not loop jumping to previous label
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] goto: to repeat a label in a different function is OK
-- Verifies: all assert() calls pass without error
do
  local function foo ()
    local a = {}
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] goto: bug in 5.2 -> 5.3.2
-- Verifies: all assert() calls pass without error
do
  do   -- bug in 5.2 -> 5.3.2
    local x
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] goto: testing closing of upvalues
-- Verifies: all assert() calls pass without error
do
  local function foo ()
    local t = {}
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] goto: testing if x goto optimizations
-- Verifies: all assert() calls pass without error
do
