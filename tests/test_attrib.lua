-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: attributes and misc
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_attrib
-- Total tests: 6
-- ==========================================================================
...
-- [Test 1] [test-suite] attrib: testing require
...
do
  ...
  -- GoLua: no package.jspath (fengari-specific)
...
-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] attrib: testing assignments, logical operators, and constructors
-- Verifies: all assert() calls pass without error
do
  local res, res2 = 27
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] attrib: test of large float/integer indices 
-- Verifies: all assert() calls pass without error
do
  a = {}
  a[true] = 20
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] attrib: test conflicts in multiple assignment
-- Verifies: all assert() calls pass without error
do
  do
    local a,i,j,b
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] attrib: repeat test with upvalues
-- Verifies: all assert() calls pass without error
do
  do
    local a,i,j,b
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] attrib: bug in 5.2 beta
-- Verifies: all assert() calls pass without error
do
  local function foo ()
    local a
