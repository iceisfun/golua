-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: table.sort
...
-- [Test 1] [test-suite] sort: testing unpack
...
-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] sort: testing unpack
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] sort: testing unpack
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] sort: testing pack
-- Verifies: all assert() calls pass without error
do
  a = table.pack()
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] sort: testing move
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] sort: testing long move
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 7] [test-suite] sort: testing sort, strange lengths
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 8] [test-suite] sort: test checks for invalid order functions
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 9] [test-suite] sort: sort alpha
-- Verifies: all assert() calls pass without error
do
  function check (a, f)
...
-- --------------------------------------------------------------------------
-- [Test 10] [test-suite] sort: sort perm
-- Verifies: all assert() calls pass without error
do
  function check (a, f)
    f = f or function (x,y) return x<y end;
...
-- --------------------------------------------------------------------------
-- [Test 11] [test-suite] sort: Invert-sorting
-- Verifies: all assert() calls pass without error
do
  function check (a, f)
    f = f or function (x,y) return x<y end;
...
-- --------------------------------------------------------------------------
-- [Test 12] [test-suite] sort: sorting
-- Verifies: all assert() calls pass without error
do
  function check (a, f)
    f = f or function (x,y) return x<y end;
