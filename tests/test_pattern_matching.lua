-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: pattern matching
...
-- [Test 1] [test-suite] pm: pattern matching
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] pm: range
-- Verifies: all assert() calls pass without error
do
  -- Build abc without deep recursion (original used recursive range)
  local t = {}
  for i = 0, 255 do t[i+1] = string.char(i) end
  local abc = table.concat(t);
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] pm: empty matches
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] pm: gsub isbalanced
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 8] [test-suite] pm: bug since 2.5 (C-stack overflow) (TODO: _soft)
-- Verifies: all assert() calls pass without error
do
  _soft = true
...
-- --------------------------------------------------------------------------
-- [Test 9] [test-suite] pm: big strings (TODO: _soft)
-- Verifies: all assert() calls pass without error
do
  _soft = true -- TODO
  if not _soft then
...
-- --------------------------------------------------------------------------
-- [Test 10] [test-suite] pm: recursive nest of gsubs
-- Verifies: all assert() calls pass without error
do
  function rev (s)
...
-- --------------------------------------------------------------------------
-- [Test 11] [test-suite] pm: gsub with tables
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 13] [test-suite] pm: tests for '%f' ('frontiers')
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 14] [test-suite] pm: malformed patterns
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 15] [test-suite] pm: \\0 in patterns
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 16] [test-suite] pm: magic char after \\0
-- Verifies: all assert() calls pass without error
do
