-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: bitwise operations
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_bitwise
-- Total tests: 8
-- ==========================================================================
...
-- [Test 1] [test-suite] bitwise: testing bitwise operations
...
do
  ...
  -- Lua 5.3 only: string coercion for bitwise ops. Lua 5.4 does not coerce strings.
  ...
  -- Lua 5.3 only: bitwise string coercion. Lua 5.4 does not coerce strings for bitwise ops.
  -- All these tests removed as they test 5.3-specific behavior.
  print("PASS")
end
--> =PASS

-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] bitwise: testing bitwise library
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] bitwise: out-of-range numbers
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] bitwise: some special cases
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] bitwise: for this test, use at most 24 bits (mantissa of a single float)
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] bitwise: testing extract/replace
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 7] [test-suite] bitwise: testing conversion of floats
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 8] [test-suite] bitwise: large floats and large-enough integers?
-- Verifies: all assert() calls pass without error
do
