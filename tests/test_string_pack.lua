-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: string.pack/unpack
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_tpack
-- Total tests: 16
-- ==========================================================================
...
-- [Test 1] [test-suite] tpack: maximum size for integers
...
-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] tpack: minimum behavior for integer formats
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] tpack: minimum behavior for integer formats
-- Verifies: all assert() calls pass without error
do
  for i = 1, NB do
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] tpack: minimum behavior for integer formats
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] tpack: minimum behavior for integer formats
-- Verifies: all assert() calls pass without error
do
  for i = 1, sizeLI do
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] tpack: sign extension
-- Verifies: all assert() calls pass without error
do
  do
    local u = 0xf0
...
-- --------------------------------------------------------------------------
-- [Test 7] [test-suite] tpack: mixed endianness
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 8] [test-suite] tpack: testing invalid formats
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 9] [test-suite] tpack: overflow in option size (error will be in digit after limit)
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 10] [test-suite] tpack: overflow in packing
-- Verifies: all assert() calls pass without error
do
  for i = 1, sizeLI - 1 do
    local umax = (1 << (i * 8)) - 1
...
-- --------------------------------------------------------------------------
-- [Test 11] [test-suite] tpack: Lua integer size
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 12] [test-suite] tpack: testing pack/unpack of floating-point numbers
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 13] [test-suite] tpack: testing pack/unpack of strings
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 14] [test-suite] tpack: testing multiple types and sequence
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 15] [test-suite] tpack: testing alignment
-- Verifies: all assert() calls pass without error
do
  do
...
-- --------------------------------------------------------------------------
-- [Test 16] [test-suite] tpack: testing initial position
-- Verifies: all assert() calls pass without error
do
  do
    ...
    -- GoLua: position 0 and -(#x+1) not rejected as out of string (minor boundary difference)
