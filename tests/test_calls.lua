-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: function calls
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_calls
-- Total tests: 16
-- ==========================================================================
...
-- [Test 1] [test-suite] calls: test 'type'
...
do
  ...
  deep(10)
  deep(50)  -- reduced from 200; GoLua Go stack limit is lower than C Lua
...
do
  ...
  -- GoLua: binary chunk loading not supported, skip those tests
...
-- GoLua: binary chunk loading not supported, skip dump/load part
do
  do
