-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: metamethods/events
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_events
-- Total tests: 13
-- ==========================================================================
...
-- [Test 1] [test-suite] events: testing metatable
...
-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] events: test for rawlen
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] events: test comparison
-- Verifies: all assert() calls pass without error
do
  t = {}
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] events: test 'partial order'
-- Verifies: all assert() calls pass without error
do
  t = {}
...
-- --------------------------------------------------------------------------
-- [Test 5] [test-suite] events: __eq between userdata
-- Requires T (C API), skip
do
  print("PASS")
end
--> =PASS
...
-- --------------------------------------------------------------------------
-- [Test 6] [test-suite] events: concat
-- Verifies: all assert() calls pass without error
do
  t = {}
...
-- --------------------------------------------------------------------------
-- [Test 7] [test-suite] events: concat metamethod x numbers (bug in 5.1.1)
-- Verifies: all assert() calls pass without error
do
  c = {}
  local x
...
-- --------------------------------------------------------------------------
-- [Test 8] [test-suite] events: test comparison compatibilities
-- Verifies: all assert() calls pass without error
do
  local t1, t2, c, d
...
-- --------------------------------------------------------------------------
-- [Test 9] [test-suite] events: test for several levels of callstest for several levels of calls
-- Verifies: all assert() calls pass without error
do
  local i
  local tt = {
...
-- --------------------------------------------------------------------------
-- [Test 10] [test-suite] events: __index on _ENV
-- Verifies: all assert() calls pass without error
do
  local _g = _G
...
-- --------------------------------------------------------------------------
-- [Test 11] [test-suite] events: testing metatables for basic types
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 12] [test-suite] events: loops in delegation
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 13] [test-suite] events: bug in 5.1
-- Verifies: all assert() calls pass without error
do
  T, K, V = nil
  grandparent = {}
