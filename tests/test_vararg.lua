-- ==========================================================================
-- Fengari test extraction: Lua 5.4 conformance: varargs
-- Source: fengari (https://github.com/fengari-lua/fengari)
-- Category: suite_vararg
-- Total tests: 4
-- ==========================================================================
...
-- [Test 1] [test-suite] vararg: testing vararg
...
-- --------------------------------------------------------------------------
-- [Test 2] [test-suite] vararg: new-style varargs
-- Verifies: all assert() calls pass without error
do
...
-- --------------------------------------------------------------------------
-- [Test 3] [test-suite] vararg: varargs for main chunks
-- Verifies: all assert() calls pass without error
do
  f = load[[ return {...} ]]
  x = f(2,3)
...
-- --------------------------------------------------------------------------
-- [Test 4] [test-suite] vararg: bug in 5.2.2
-- Verifies: all assert() calls pass without error
do
