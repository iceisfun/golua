-- Test: math.lua - math.random small intervals
-- From: math.lua
-- What: Tests that math.random(x1, x2) eventually produces every value in small ranges, including unit sets and boundary values.
