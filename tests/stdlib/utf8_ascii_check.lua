-- Test: Basic ASCII string check
-- From: utf8.lua
-- What: Tests the full check helper on a plain ASCII string, verifying utf8.len, utf8.char, utf8.codepoint, utf8.offset, utf8.codes, and charpattern.
