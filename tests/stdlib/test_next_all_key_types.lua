...
-- From: nextvar.lua
-- What: Tests that next/pairs correctly iterates a table with integer, float, short string, long string, C function, Lua function, thread, boolean, userdata, and table keys.
