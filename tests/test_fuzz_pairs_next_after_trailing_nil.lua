...
-- Variant 2: table.create(narr) + sparse subsequent fills
local u = table.create(10)
u[1], u[2], u[3] = 1, 2, 3
u[5], u[6] = 5, 6
u[8] = 8
...
for k, v in pairs(u) do
  count2 = count2 + 1
  assert(count2 <= 10, "pairs(table.create(...)) infinite loop at k=" .. tostring(k))
end
assert(count2 == 6, "expected 6 keys, got " .. count2)
