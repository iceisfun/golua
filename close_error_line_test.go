...
// same source line as reference Lua 5.4.8. For block scopes (do/if/while/for)
// Lua uses ls->lastline at leaveblock — the last statement inside the block.
// For repeat...until the close is attributed to the until-condition line; for a
